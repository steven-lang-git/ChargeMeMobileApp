...
export default class PushNotifications extends React.Component {
  ...
  componentDidMount(){
    AsyncStorage.getItem('isSwitchOnP').then((value) =>
      this.setState({isSwitchOnP: JSON.parse(value)}));
    console.log(this.state.isSwitchOnP);
  ...
  _handleToggleSwitch = (value) => {
    ...
    AsyncStorage.setItem('isSwitchOnP', JSON.stringify(value));
    this.setState({ isSwitchOnP: value });
  }
    ...
    return (
      <SafeAreaView style={styles.container}>
        <ImageBackground source={require('../../../../assets/blue.jpg')} style={styles.imageContainer}>
          ...
          <Text>
            <Text style={styles.labeltxt}>PUSH NOTIFICATIONS </Text>
          </Text>
          <View style={styles.switchContainer}>
            <Switch
              value={this.state.isSwitchOnP}
